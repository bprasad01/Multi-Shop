            ...
            <div className="col-lg-3 col-md-4 col-sm-6 pb-1" style={{ cursor : "pointer"}} key={item.id}>
                ...
                <div className="product-item bg-light mb-4">
                    <div className="product-img position-relative overflow-hidden">
                        {item.images.slice(0,1).map(imgData => (
                            <img className="img-fluid w-100" src={imgData.src} alt="product" key={imgData.id}/>
                        ))}
                    ...
                    <div className="text-center py-4">
                        ...
                        <div className="d-flex align-items-center justify-content-center mt-2">
                            <h5>${item.prices.price}</h5><h6 className="text-muted ml-2"><del>${item.prices.regular_price}</del></h6>
                        </div>
