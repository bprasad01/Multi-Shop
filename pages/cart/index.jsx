                    ...
                    <tbody className="align-middle">
                        ...
                        <tr key={product.id}>
                            ...
                            <td className="align-middle">
                                    <img src={imgData.src} alt="" style={{width : "50px"}} />{product.name}</td>
                                ))}
                            <td className="align-middle">${product.prices.price}</td>
                            <td className="align-middle">
                            ...
                            <td className="align-middle">${product.prices.price * product.quantity}</td>
                            <td className="align-middle"><button onClick={removeCartItem} className="btn btn-sm btn-danger"><FaTimes /></button></td>
                        </tr>
                        ))}
                    </tbody>
                </table>
